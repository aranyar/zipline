...
class HermesInterruptTest {
  ...
  @Test fun interruptedAfterEnoughComputations() {
    ...
    jsEngine.interruptHandler = counter
    ...
    val result = jsEngine.evaluate("""fib(17)""")
  ...
  @Test fun removeInterruptHandler() {
    ...
    assertEquals(10946, jsEngine.evaluate("""fib(20)"""))
    assertEquals(4, counter.count)

    jsEngine.interruptHandler = null
  ...
  @Test fun interruptionAreNotReentrant() {
    ...
    assertEquals(2584, jsEngine.evaluate("""fib(17)"""))
