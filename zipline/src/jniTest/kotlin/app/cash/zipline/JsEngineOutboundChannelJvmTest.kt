...
class HermesOutboundChannelJvmTest {
  ...
  fun jvmExceptionsWithUnifiedStackTrace() {
    ...
    assertThat(stackTrace).contains("JsEngine.execute(Native Method)")

    // And this test method.
    assertThat(stackTrace).contains("HermesOutboundChannelJvmTest.jvmExceptionsWithUnifiedStackTrace")
  }
}
